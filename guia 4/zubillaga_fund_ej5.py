...
account_3 = {"user_id": "1482", "password": "LaConfiable33", "saving_bank": {"account_num": "CA-300463", "amount": 8000},
    ...
    try:
        for count in accounts:
            if cuenta["usuario"] == count["user_id"]:
                ...
                amoun = int(input("\t \t >> "))
                count['saving_bank']["amount"] = count['saving_bank']["amount"] + float(amoun)
